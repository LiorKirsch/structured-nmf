function parms = get_structure_matrix(dataset, structure_type, ...
                                               selected_regions, parms)
% 
  num_regions = length(selected_regions);

  dataset_cell = strsplit(dataset,'_');
  dataset_prefix = dataset_cell{1};
  switch dataset_prefix
    case 'Human6'
        ...
        [parms.structure_matrix, parms.relation_regions] = ...
            get_relation_structure(parms, parms.structure_matrix, ...
                                   parms.relation_regions, ...
                                   selected_regions, structure_type);
        
    case {'kang', 'brainspan'}
        [parms.structure_matrix, parms.relation_regions] = ...
            kang_tree_structure(selected_regions);
        [parms.structure_matrix,parms.relation_regions] = ...
            get_relation_structure(parms, parms.structure_matrix, ...
                                   parms.relation_regions, ...
                                   selected_regions, structure_type);
    ...
    case 'Zapala'
        [parms.structure_matrix, parms.relation_regions] = ...
            zapala_tree_structure(selected_regions);
        [parms.structure_matrix,parms.relation_regions] = ...
            get_relation_structure(parms, parms.structure_matrix, ...
                                   parms.relation_regions, ...
                                   selected_regions, structure_type);
