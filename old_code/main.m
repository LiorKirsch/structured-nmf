...
% % Removed markers from file name % num_markers_list =
% take_from_struct(parms, 'num_markers_list', [5 20 50 100 200]);
%%%
...
[results ,H_results, W_results] = loopOverHyperparms_real(X, gene_info, parms, ...
                                  loop_over_var_name, ...
                                  loop_over_var_value ,'');
