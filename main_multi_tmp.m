...
% [parms.structure_matrix,parms.relation_regions] = get_relation_structure(parms, parms.structure_matrix,parms.relation_regions,mix_data.region,parms.structre_type,mix_data.expression);


parms.do_sep_init = true;
parms.num_samples = 5; 

alg_list = {'mm','cjlin','alsBlockpivot','alsActiveSet'}; % 'alsPinv' 'alsBlockpivot','cjlin', 'prob'}; 
...
for i = 1:length(loop_over_var_value{1});
    ...
    set(gca,'FontSize', 18);
%     set(FigHandle, 'Position', [100, 100, 400, 450]);
