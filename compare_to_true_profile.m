function [gene_inds_true_type,gene_inds_predictions, ...
        ...
        compare_to_true_profile(true_cell_types,gene_info, species,parms)
...
%             true_cell_types = load_data('barres2014');
            ...
            [intersect_symb, gene_inds_true_type, gene_inds_predictions] = ...
                intersect(true_cell_types.gene_symbols, gene_info.gene_symbols);
            gene_symb_true_type = intersect_symb;
            gene_symb_predictions = intersect_symb;
        case 'okaty'
            switch species
                case 'mouse'
                    ...
                    reorder_mouse_cell_type = ...
                        true_cell_types.refer_to_index(reorder_mouse_cell_type);
                    ...
                    gene_symb_true_type  = true_cell_types.gene_symbol(reorder_mouse_cell_type);
